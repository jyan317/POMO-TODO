...
public abstract class Todo {
    ...
    // MODIFIES: this
    // EFFECTS: set the "description" using the given description
    //          sets "progress" and "estimated time to complete" to zero
    // throws EmptyStringException if description is null or empty
    public Todo(String description) {
        if (description == null || description.length() == 0) {
            throw new EmptyStringException("Cannot construct without description");
        }
    ...
    // EFFECTS: returns an integer between 0 and 100 with represents
