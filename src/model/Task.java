...
public class Task extends Todo {
    ...
    public void addTag(String tagName) {
        addTag(TagFactory.getTagWithName(tagName));
    }
    ...
    public void removeTag(String tagName) {
        removeTag(TagFactory.getTagWithName(tagName));
    }
    ...
    public boolean containsTag(String tagName) {
        ...
        return containsTag(TagFactory.getTagWithName(tagName));
    }
    ...
    public void setEstimatedTimeToComplete(int hours) {
        if (hours < 0) {
            throw new NegativeInputException("Estimated time to complete task must be non-negative");
        }
        etcHours = hours;
    }
