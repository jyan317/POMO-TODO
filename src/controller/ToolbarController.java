...
import static run.PomoTodoApp.setScene;
...
public class ToolbarController implements Initializable {
    ...
    // REQUIRES: name != null
    // MODIFIES: this
    // EFFECTS: updates the Toolbar UI label to name
        ...
        private void submit() {
            ...
            switch (selectedIndex) {
                case 0:
                    ...
                    break;
                case 1:
                    Logger.log("ToolbarViewOptionsPopUpController", "Priority View Selected");
                    setScene(new PriorityView(PomoTodoApp.getTasks()));
                    break;
                case 2:
    ...
    class ToolbarPopUpController {
        ...
        private void submit() {
            ...
            switch (selectedIndex) {
                case 0:
                    Logger.log("ToolbarOptionsPopUpController", "Settings is not supported in this version");
                    break;
                case 1:
